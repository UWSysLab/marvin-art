...
inline size_t Array::SizeOf() {
  SWAP_PREAMBLE_TEMPLATE(SizeOf, Array, size_t, GATHER_TEMPLATE_ARGS(kVerifyFlags, kReadBarrierOption), )
...
inline T PointerArray::GetElementPtrSize(uint32_t idx, size_t ptr_size) {
  SWAP_PREAMBLE_TEMPLATE(GetElementPtrSize, PointerArray, T, GATHER_TEMPLATE_ARGS(T, kVerifyFlags, kReadBarrierOption), idx, ptr_size)
...
inline void PointerArray::Fixup(mirror::PointerArray* dest,
  ...
  SWAP_PREAMBLE_TEMPLATE_VOID(Fixup, PointerArray, GATHER_TEMPLATE_ARGS(kVerifyFlags, kReadBarrierOption, Visitor), dest, pointer_size, visitor)
