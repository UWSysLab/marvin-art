...
class Heap {
 public:
  std::vector<space::Space*> marvininst_spaces_;
  std::vector<collector::GarbageCollector*>* marvininst_GetGarbageCollectors() { return &garbage_collectors_; }
  collector::GarbageCollector* marvininst_GetSemiSpace() { return (collector::GarbageCollector*)semi_space_collector_; }
  collector::GarbageCollector* marvininst_GetMarkCompact() { return (collector::GarbageCollector*)mark_compact_collector_; }
  collector::GarbageCollector* marvininst_GetConcurrentCopying() { return (collector::GarbageCollector*)concurrent_copying_collector_; }
